      ...
      content: RichText(
        text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(text: '\n\n'),
            TextSpan(text: 'If '),
            TextSpan(text: 'you are registered, but you forgot your password', style: TextStyle(fontWeight: FontWeight.bold)),
            TextSpan(text: ', type your email, '),
            TextSpan(text: 'new password ', style: TextStyle(fontWeight: FontWeight.bold)),
            TextSpan(text: 'and click on checkbox '),
            TextSpan(text: 'Restore password ', style: TextStyle(fontWeight: FontWeight.bold)),
